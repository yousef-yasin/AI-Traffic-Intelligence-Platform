    ...
    <main class="monitoring-page">
      ...
      <section class="monitoring-hero">
        <div>
          ...
          <p>
            Live camera detections, GPS incidents and SUMO traffic-impact
            analysis in one operational view.
          </p>
        </div>
      ...
      <section
        ...
        aria-label="Road monitoring summary"
      >
        ...
        <article class="monitoring-summary-card">
          ...
          <div>
            <small>Monitored roads</small>
            <strong id="monitoring-road-count">0</strong>
          </div>
        </article>
        ...
        <article class="monitoring-summary-card">
          ...
          <div>
            ...
            <strong id="monitoring-incident-count">0</strong>
          </div>
        </article>
        ...
        <article class="monitoring-summary-card">
          ...
          <div>
            <small>Average road health</small>
            <strong id="monitoring-health-score">—</strong>
          </div>
        </article>
        ...
        <article class="monitoring-summary-card">
          ...
          <div>
            ...
            <strong id="monitoring-data-status">Stored</strong>
          </div>
        </article>
      ...
      <section class="monitoring-top-grid">
        ...
        <article class="card monitoring-map-card">
          ...
          <div class="monitoring-map-footer">
            <span>
              ...
              Data is loaded from the persistent JRIP database
            </span>

            <span id="monitoring-last-update">
              Waiting for data…
            </span>
          </div>
        ...
        <article class="card monitoring-alert-card">
          ...
          <div class="monitoring-card-heading compact">
            ...
            <span class="soft-pill" id="alert-count-pill">
              0 active
            </span>
      ...
      <section class="card simulation-workspace">
        ...
        <div class="simulation-header">
          ...
          <div>
            ...
            <p>
              Simulate how detected road damage affects speed,
              congestion and travel delay before maintenance
              decisions are made.
            </p>
          </div>
        ...
        <div class="simulation-grid">
          ...
          <div class="simulation-canvas-wrap">
            ...
            >
              ...
              <div class="simulation-placeholder-copy">
                ...
                <span>
                  The Python simulation API will stream
          ...
          <aside class="simulation-metrics">
            ...
            <article>
              ...
              <strong id="sim-congestion">Ready</strong>
            </article>
      ...
      <section class="monitoring-analysis-grid">
            ...
            <div class="comparison-pane real-data-pane">
              ...
              <dl>
                <div>
                  ...
                  <dd id="comparison-incidents">0</dd>
                </div>

                <div>
                  <dt>Average road health</dt>
                  <dd id="comparison-health">—</dd>
                </div>

                <div>
                  <dt>Affected location</dt>
                  <dd id="comparison-location">
                    Not available
                  </dd>
                </div>
              </dl>
            ...
            <div class="comparison-pane simulation-data-pane">
              ...
              <dl>
                ...
                <div>
                  ...
                  <dd id="comparison-delay">—</dd>
                </div>

                <div>
                  <dt>Suggested diversion</dt>
                  <dd id="comparison-diversion">—</dd>
                </div>
              </dl>
        ...
        <article class="card recommendation-card">
          ...
          <div>
            ...
            <p id="simulation-recommendation">
              Select a scenario and start the simulation
              to generate a traffic-aware maintenance
              recommendation.
            </p>
          </div>
